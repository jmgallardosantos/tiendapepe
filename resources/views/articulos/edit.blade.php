<x-app-layout>
    <div class="w-1/2 mx-auto">
        <form method="POST"
            ...
            <div>
                <x-input-label for="stocks" :value="'cantidad de articulos'" />
                <x-text-input id="stocks" class="block mt-1 w-full"
                    type="text" name="stocks" :value="old('stocks', $articulo->stocks)" required
                    autofocus autocomplete="stocks" />
